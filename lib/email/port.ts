 ...
 * 2. Nenhum teste precisa de rede. O dreno recebe um `EmailSender` e nao sabe
...
export type SendResult =
  ...
  /**
   * `retriable` decide se a linha volta para a fila ou morre. Nao e detalhe:
   * retentar endereco invalido para sempre queima a cota de 300/dia.
   */
