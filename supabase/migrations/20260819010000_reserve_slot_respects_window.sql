-- =============================================================================
-- Migration: reserve_registration_slot respeita a janela de inscricao
-- As datas do campeonato passam a trancar a porta no banco, e nao so na tela.
-- CREATE OR REPLACE sobre a funcao de 20260818040000, que nao pode ser editada
